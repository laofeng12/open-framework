package org.ljdp.support.web.loader;
...
public class LjdpWebLoader {

	private static boolean loadMemcached = false;
	
	public static void contextDestroyed(ServletContextEvent arg0) {
	...
	public static void contextInitialized() {
		...
		try {
	    	...
	    	//公共缓存
	    	MemoryCache.initCache(DictConstants.CACHE_COMMON, CacheType.LIFE);
	    	MemoryCache.config(DictConstants.CACHE_COMMON, CacheParam.TIME_LIFE_MINUTE, 30);
