...
public class ImageAddFrontTest {
	...
	private Font font = new Font("微软雅黑", Font.PLAIN, 100);// 添加字体的属性设置
	...
	public static void main(String[] args) {
		...
		BufferedImage t1 = tt.modifyImage(source, "张三峰", 402, 900);
		BufferedImage t2 = tt.modifyImage(t1, "阅读能力提升", 1684, 1408);
