...
<#if model == "">
import com.${corp}.${sys}.${module}.component.${table.modelName}BatchBO;
<#else>
import com.${corp}.${sys}.${module}.${model}.component.${table.modelName}BatchBO;
</#if>
 ...
 *
 */
@Api(tags="${resName}批量导入")
@RestController
<#if model == "">
@RequestMapping("/${sys}/${module}/${table.modelName2}/batch")
<#else>
@RequestMapping("/${sys}/${module}/${model}/${table.modelName2}/batch")
</#if>
public class ${table.modelName}BatchAction extends AbstractBatchComController {
	@Resource
	private LjdpFileuploadConfig fileuploadConfig;
	@Resource
	private RedisTemplate<String, Object> redisTemplate;
	@Resource
	private ${table.modelName}BatchBO ${table.modelName2}BatchBO;
...
//		String fileName = "导入测试example-.xlsx";
		String batchType = "${tableModelName}导入";
		return super.doBatchProcess(${table.modelName2}BatchBO, fullFilePath,
