...
function setIframeHeight(iframe) {
	if (iframe) {
		...
		$('#resTree').height(document.body.scrollHeight-50)
	}
};
...
<body>
	...
	<div class="row">
		...
		<div class="l-layout-header">
			<div class="l-layout-header-inner">菜单管理</div>
		</div>
	...
	<script src="${pageContext.request.contextPath}/servjs/admin/res/sysResTree.js?v=${jver}"></script>
	<script type="text/javascript">
