...
<body class="white-bg">
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="like_sysname">
						</div>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<select class="form-control m-b" name="eq_isactive"
	...
	<script src="${pageContext.request.contextPath}/servjs/admin/sys/sysSubsystemControl.js?v=${jver}"></script>
<script type="text/javascript">
