...
<body class="white-bg">
	<div class="container animated fadeInLeft">
		<div class="ibox-title">
			<h5>子系统管理 <small>基础信息配置</small></h5>
		</div>
			...
			<form id="contentForm" method="post" class="form-horizontal">
				...
				<div class="row">
					<div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                        <input type="text" class="form-control" name="sysname" value="${m.sysname}">
	                    </div>
	                </div>
	            </div>
	            <div class="hr-line-dashed"></div>
				...
				<div class="row">
					<div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                        <input type="text" class="form-control" name="logo" value="${m.logo}">
	                    </div>
	                </div>
	            </div>
	            <div class="hr-line-dashed"></div>
				...
				<div class="row">
					<div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                        <input type="text" class="form-control" name="homepage" value="${m.homepage}">
	                    </div>
	                </div>
	            </div>
	            <div class="hr-line-dashed"></div>
				...
				<div class="row">
					<div class="form-group">
	                    ...
	                    <div class="col-sm-10">
							<select class="form-control" name="needorg" value="${m.needorg}"
						      	mvc_combox="${pageContext.request.contextPath}/api/framework/sys/code/list?codetype=public.YN">
						      	<option value="">==请选择==</option>
						    </select>
	                    </div>
				...
				<div class="row">
					<div class="form-group">
	                    ...
	                    <div class="col-sm-10">
							<select class="form-control" name="isactive" value="${m.isactive}"
						      	mvc_combox="${pageContext.request.contextPath}/api/framework/sys/code/list?codetype=public.YN">
						      	<option value="">==请选择==</option>
						    </select>
	                    </div>
				...
				<div class="row">
					<div class="form-group">
	                    ...
	                    <div class="col-sm-10">
							<select class="form-control" name="islocal" value="${m.islocal}"
						      	mvc_combox="${pageContext.request.contextPath}/api/framework/sys/code/list?codetype=public.YN">
						      	<option value="">==请选择==</option>
						    </select>
	                    </div>
	...
	$(document).ready(function () {
		mvc.ready(function(){
			...
			$('[name=needorg]').val("${m.needorg}")
			$('[name=isactive]').val("${m.isactive}")
			$('[name=islocal]').val("${m.islocal}")
		});
		//改为 ajax提交
