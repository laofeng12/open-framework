...
<body class="white-bg">
	<div class="container-fluid animated fadeInRight">
		<div class="ibox-content">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<select class="form-control m-b" name="eq_enabled"
			...
			<div id="myToolbar" class="btn-group hidden-xs" role="group">
				...
				<button type="button" class="btn btn-outline btn-default" id="setResBtn">
					<i class="glyphicon glyphicon-th-list" aria-hidden="true"></i> 设置权限
				</button>
			</div>
			<!-- 分页表格 -->
			<table id="myTable" style="width: 1700px">
	...
	<script src="${pageContext.request.contextPath}/servjs/admin/role/sysRoleControl.js?v=${jver}"></script>
<script type="text/javascript">
